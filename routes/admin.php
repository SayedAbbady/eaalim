...
Route::group(['prefix' => 'admin', 'namespace'=>'admin', 'middleware'=>'auth'], function () {
  ...
  Route::post('/unit/delete','UnitController@deleteUnit');
  ...
  Route::post('/section/delete','SectionController@deleteSection');
  ...
  Route::post('/level/delete','LevelController@deleteLevel');
  ...
  Route::post('/lesson/delete','LessonController@deleteLesson');
  ...
  Route::post('/staff/staffDelete',"AdminController@deletestaff");
  //***********************************************************
